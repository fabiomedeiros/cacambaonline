...
namespace cacambaonline.Controllers
{
    public class PessoasController : Controller
    {
        ...
        public PessoasController(MeuDbContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,AspNetUsersId,Nome,Cpf")] Pessoas pessoas)
        {
            if (id != pessoas.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MeuDbContext.Pessoas'  is null.");
            }
            var pessoas = await _context.Pessoas.FindAsync(id);
            if (pessoas != null)
            {
